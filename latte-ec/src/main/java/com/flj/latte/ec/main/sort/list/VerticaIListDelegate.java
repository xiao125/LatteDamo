...
public class VerticaIListDelegate extends LatteDelegate {
                ...
                .success(new ISuccess() {
                    ...
                    public void onSuccess(String response) {
                        final List<MultipleItemEntity> data = new VerticalListDataConverter()
                                .setJsonData(response).convert();  //解析json数据
                        final SortDelegate delegate = getParentDelegate();
                        final SortRecyclerAdapter adapter = new SortRecyclerAdapter(data,delegate); //商品类别适配器
