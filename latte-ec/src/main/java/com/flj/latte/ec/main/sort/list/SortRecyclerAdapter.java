...
public class SortRecyclerAdapter extends MultipleRecyclerAdapter {
            ...
            case ItemType.VERTICAL_MENU_LIST:
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (mPrePosition !=currentPosition){ //如果不是选择第一个分类
                            //还原上一个
                            getData().get(mPrePosition).setField(MultipleFields.TAG,false); //设置第一个分类没有被选中
                            ...
                            final int contentId = getData().get(currentPosition).getField(MultipleFields.ID);//获取到选中的分类商品id
    ...
    private void showContent(int contentId){
        ...
        final ContentDelegate delegate = ContentDelegate.newInstance(contentId); //分类对应的商品Fragment(右边)
