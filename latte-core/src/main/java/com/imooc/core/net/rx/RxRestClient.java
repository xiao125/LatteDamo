...
public  final class RxRestClient {
    ...
    private final LoaderStyle LOADER_STYLE; // Loading 样式
    ...
    private Observable<String> request(HttpMethod method){
        ...
        final RxRestService service = RxRestCreator.getRxRestService(); //获取RxRestService 请求
        Observable<String> observable = null;

        if (LOADER_STYLE !=null){
            LatteLoader.showLoading(CONTEXT,LOADER_STYLE); //Loading
        }
    ...
    public final Observable<RequestBody> download(){
